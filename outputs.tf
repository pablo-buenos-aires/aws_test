...
output "instance_public_dns" {
  ...
  value       = aws_instance.test_server1.public_dns
}
output "instance_hostname1" {
  description = "DNS name of the EC2 instance."
  value       = aws_instance.test_server1.private_dns
}

output "instance_hostname2" {
  description = "DNS name of the EC2 instance."
  value       = aws_instance.test_server2.private_dns
}

output "instance_hostname3" {
  description = "DNS name of the EC2 instance."
